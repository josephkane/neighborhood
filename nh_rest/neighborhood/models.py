...
class House(models.Model):
	...
	agent = models.ForeignKey(Agent, null=True, on_delete=models.SET_NULL, related_name="house_agent")
	...
	neighborhood = models.ForeignKey(Neighborhood, null=True, on_delete=models.SET_NULL, related_name="house_neighborhood")
...
class Owner(User):
	house = models.ForeignKey(House, null=True, on_delete=models.SET_NULL, related_name="owner_house")
